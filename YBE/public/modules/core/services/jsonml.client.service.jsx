    ...
    .service('JSONML', [
        ...
        function () {
            /*
				...
				*/
            var addChildren = function ( /*DOM*/ elem, /*function*/ filter, /*JsonML*/
                jml) {
             ...
             * @return {array} JsonML
             */
            var fromHTML = this.fromHTML = function (elem, filter) {
                    ...
                    for (i = 0; attr && i < attr.length; i++) {
                        if (attr[i].specified) {
                            if (attr[i].name === 'style') {
                                props.style = elem.style.cssText || attr[i]
                                    .value;
                ...
                case 10: // doctype
                    jml = ['!'];
                    var type = ['DOCTYPE', (elem.name || 'html')
                        .toLowerCase()
                    ];
                    if (elem.publicId) {
             ...
             * @return {array} JsonML
             */
            this.fromHTMLText = function (html, filter) {
